    ...
    <nav className="flex flex-row justify-between items-center my-10 mx-5 gap-5">
      ...
      <ul
        className={`flex flex-row justify-end items-center gap-10 ${
          isClicked
            ? ' xs:left-8 xs:w-auto md:flex-col md:gap-4 md:h-auto md:absolute md:top-[100px] md:right-8 md:w-2/5 backdrop-blur-lg md:border md:border-slate-300/30 md:rounded-lg'
            : 'md:hidden'
        }`}
      >
